			...
			>
				<div className='flex container'>
					<div id="hero-content" className='flex flex-col items-start w-full'>
						<img src="/images/logo2.png" className="h-8 mb-20 md:hidden"></img>
						...
						<div>
							<div className="reveal-title relative inline-block mb-4">
								...
								<span className="reveal-title-content invisible">
									<h1 className="w-auto inline-block text-4xl lg:text-6xl font-semibold text-white leading-snug">Hey, Im <span className='text-primaryBrand'>John</span></h1>
								</span>
							</div>
						</div>
